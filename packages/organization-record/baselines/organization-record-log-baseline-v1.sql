-- New-lineage baseline v1 for immutable Organization Record truth.
--
...
WHEN NOT EXISTS (
  ...
  WHERE record.position = NEW.record_position
    ...
    AND json_extract(record.canonical_envelope, '$.body.human_act_resolution_ref.policy_id') = NEW.policy_id
