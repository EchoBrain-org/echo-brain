...
Authority and protocol workspaces:
...
- public P-256 signing-key descriptor verification.
...
Descriptor protection and assurance
...
consumer that uses these primitives.
