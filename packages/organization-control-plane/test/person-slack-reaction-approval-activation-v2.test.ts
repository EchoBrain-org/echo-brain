...
import {
  PersonSlackReactionApprovalActivationConflictError,
  PersonSlackReactionApprovalActivationDeniedError,
  activatePersonSlackReactionApprovalV2,
  type CurrentAuthorityMembershipV2,
  type FrozenApprovalContractV2,
  type PersonSlackReactionApprovalActivationCommandV2,
  type PersonSlackReactionApprovalActivationCoordinatorV2,
  type PersonSlackReactionApprovalActivationFenceV2,
  type PersonSlackReactionApprovalActivationResultV2,
  type PersonSlackReactionApprovalActivationTransactionV2,
...
function command(
  patch: Partial<PersonSlackReactionApprovalActivationCommandV2> = {},
...
class FakeCoordinator implements PersonSlackReactionApprovalActivationCoordinatorV2 {
  ...
  async withStableAdministratorActivation<T>(
    ...
    const transaction: PersonSlackReactionApprovalActivationTransactionV2 = {
...
describe("private Person Slack reaction approval activation v2", () => {
  ...
  it("replays the exact command and conflicts every changed semantic field", async () => {
    ...
    const mutations: Partial<PersonSlackReactionApprovalActivationCommandV2>[] = [
  ...
  it("denies Person sessions and obsolete caller-selected authority fields before a transaction", async () => {
    ...
    ).rejects.toBeInstanceOf(PersonSlackReactionApprovalActivationDeniedError);
    await expect(
