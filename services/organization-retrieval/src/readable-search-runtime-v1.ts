...
export interface ReadableSearchLineageV1 {
  readonly authority_id: string;
  readonly organization_id: string;
  readonly state_lineage_id: string;
  readonly planes: Readonly<{
    facts: ReadableSearchLineagePlaneV1;
    content: ReadableSearchLineagePlaneV1;
    lexical: ReadableSearchLineagePlaneV1;
  }>;
}
export interface ReadableSearchExactHeadV1 {
  readonly authority_id: string;
  readonly organization_id: string;
  readonly state_lineage_id: string;
...
export interface BuildReadableSearchGenerationV1Input {
  readonly state_directory: string;
  readonly lineage: ReadableSearchLineageV1;
...
export interface ReadableSearchGenerationManifestV1 {
  readonly schema_version: 1;
...
function provenanceBinding(atom: ReadableSearchAtomV1): Sha256Digest {
  return canonicalSha256({
    schema_version: 1,
  ...
  try {
    ...
    for (const database of databases.values())
      database
        ...
        .run();
    const manifest: ReadableSearchSegmentManifestV1 = {
      schema_version: 1,
...
export function buildReadableSearchGenerationV1(
  ...
  try {
    ...
    const manifest: ReadableSearchGenerationManifestV1 = {
      ...withoutIdentity,
...
export interface ReadableSearchActiveGenerationV1 {
  readonly generation_id: Sha256Digest;
  readonly manifest_sha256: Sha256Digest;
  readonly retrieval_contract_sha256: Sha256Digest;
  readonly exact_head: ReadableSearchExactHeadV1;
...
function assertExactHead(
  value: ReadableSearchExactHeadV1,
  label: string,
): void {
...
function sameExactHead(
  left: ReadableSearchExactHeadV1,
  right: ReadableSearchExactHeadV1,
): boolean {
  return (
...
function assertCleanGenerationManifest(
  ...
  assertExactHead(
    manifest.exact_head as ReadableSearchExactHeadV1,
...
function assertSegmentManifest(
  value: unknown,
): asserts value is ReadableSearchSegmentManifestV1 {
  const manifest = value as Partial<ReadableSearchSegmentManifestV1>;
  if (
    manifest.schema_version !== 1 ||
...
function validateCleanPlaneLineage(
  ...
  segment: ReadableSearchSegmentManifestV1,
): void {
...
export function warmReadableSearchActiveGenerationV1(input: {
  readonly state_directory: string;
  readonly active_generation: ReadableSearchActiveGenerationV1;
}): void {
  validatedActiveGenerationHandleV1 = null;
  validateAndWarmReadableSearchGenerationV1({
    ...input,
