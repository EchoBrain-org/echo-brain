...
} from "../presentation/private-slack-approval-interactions-http-application-v1.js";

/** Adapts the generic raw HTTP ingress to Slack's two signed headers. */
export function createPrivateSlackApprovalInteractionHttpIngressV1(
  application: PrivateSlackApprovalInteractionsHttpApplicationV1,
): PrivateApprovalInteractionHttpApplicationV1 {
  return Object.freeze({
    method: "POST",
    path: PRIVATE_SLACK_APPROVAL_INTERACTIONS_PATH_V1,
