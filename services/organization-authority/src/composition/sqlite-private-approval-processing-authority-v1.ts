...
import {
  type PrivateApprovalProcessingAuthorityV1,
  type PrivateApprovalProcessingFrozenCandidateV1,
} from "./private-approval-processing-coordinator-v1.js";
import {
...
export interface PrivateApprovalProcessingAuthorityCoordinatesV1 {
  readonly authority_id: string;
  readonly organization_id: string;
  readonly state_lineage_id: string;
}

export interface SqlitePrivateApprovalProcessingAuthorityV1Options {
  readonly source: SqliteCleanLiveOnlySourceStateV1;
  readonly assignments: SqlitePrivateApprovalAssignmentStateV1;
  readonly coordinates: PrivateApprovalProcessingAuthorityCoordinatesV1;
}
...
function exactCoordinates(
  coordinates: PrivateApprovalProcessingAuthorityCoordinatesV1,
): void {
...
/**
 * Concrete Authority port for `PrivateApprovalProcessingCoordinatorV1`.
 *
 ...
 */
export class SqlitePrivateApprovalProcessingAuthorityV1
  implements PrivateApprovalProcessingAuthorityV1
{
  private readonly source: SqliteCleanLiveOnlySourceStateV1;
  private readonly assignments: SqlitePrivateApprovalAssignmentStateV1;
  private readonly coordinates: PrivateApprovalProcessingAuthorityCoordinatesV1;

  constructor(options: SqlitePrivateApprovalProcessingAuthorityV1Options) {
  ...
  async readFrozenCandidateForApproval(
    approvalId: string,
  ): Promise<PrivateApprovalProcessingFrozenCandidateV1 | undefined> {
