...
import { HttpGranolaApiClient } from "@echo-brain/provider-granola/source/granola-api-client";
import { type GranolaRecordOwnerObservationClient } from "@echo-brain/provider-granola/source/record-owner-observation";
...
const USAGE =
  "usage: granola meeting-source admission " +
