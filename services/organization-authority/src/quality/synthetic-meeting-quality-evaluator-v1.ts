...
export const phaseOneSyntheticExtractionExpectationsV1: readonly SyntheticExtractionExpectationV1[] =
  Object.freeze([
    ...
    expectedTriple("synthetic-pp-04", "Run a clean workspace rebuild before each checkpoint tag.", "Remove build artifacts and rebuild every workspace.", "A warm cache can conceal missing exports or generated files."),
    ...
    expectedTriple("synthetic-pp-07", "Merge the migration branch directly into main after Band B.", "Skip a separate founder review checkpoint.", "The synthetic test suite is already green."),
    ...
    expectedTriple("synthetic-pp-10", "Reuse live Slack credentials in the synthetic harness.", "Resolve fixture approvals through the production channel.", "Live reactions would exercise the existing surface."),
