...
import {
  PrivateApprovalProcessingCoordinatorV1,
  type PrivateApprovalProcessingAuthorityV1,
  type PrivateApprovalProcessingFrozenCandidateV1,
} from "../../src/composition/private-approval-processing-coordinator-v1.js";
...
function frozen(): PrivateApprovalProcessingFrozenCandidateV1 {
  return {
  ...
  } as PrivateApprovalProcessingFrozenCandidateV1;
}
...
describe("private approval processing coordinator v1", () => {
