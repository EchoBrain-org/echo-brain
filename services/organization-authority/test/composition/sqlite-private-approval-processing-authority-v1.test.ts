...
import {
  SqlitePrivateApprovalProcessingAuthorityV1,
} from "../../src/composition/sqlite-private-approval-processing-authority-v1.js";
import type { SqlitePrivateApprovalAssignmentStateV1 } from "../../src/composition/sqlite-private-approval-assignment-state-v1.js";
...
function harness(input = sourceCandidate()) {
  ...
  const adapter = new SqlitePrivateApprovalProcessingAuthorityV1({
    source: source as unknown as SqliteCleanLiveOnlySourceStateV1,
    assignments: assignments as unknown as SqlitePrivateApprovalAssignmentStateV1,
    coordinates: {
