...
import { SLACK_ORGANIZATION_TOOL_REQUIRED_SCOPES } from "../../../../../../../packages/organization-control-plane/src/application/slack-integration-contracts.js";
...
} from "../../../../../src/composition/providers/slack/private-approval/resolve-current-private-slack-connection-v1.js";
...
function seed(
  ...
  const state = buildOrganizationToolConnectionStateV2({
    ...
    observed_granted_scopes: SLACK_ORGANIZATION_TOOL_REQUIRED_SCOPES,
