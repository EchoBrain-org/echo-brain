...
it("pins the current baseline bytes", () => {
  expect(authorityBaselineSha256V8()).toBe("sha256:a7b3dab8ca3f7b84c7f98f482fd99a7320dc54a47346d0038515feceb9c6a3c6");
...
it("initializes only the active storage roles and tables", () => {
  ...
  for (const [file, count, version] of [["authority.sqlite", 41, 8], ["integrations.sqlite", 11, 3], ["record-log.sqlite", 5, 3]] as const) {
