...
} from "./person-slack-approval-activation-v2.js";

const PROVIDER_EXPECTATION_KIND =
  "echo-person-slack-provider-expectation-v2" as const;

export interface ReprovedFrozenPersonSlackApprovalV2 {
...
export interface PersonSlackApprovalProviderExpectationV2 {
...
export type PersonSlackApprovalProviderResultV2 =
  | {
...
export type PersonSlackApprovalFinalizationResultV2 =
...
export interface PersonSlackApprovalFinalizationTransactionV2 {
  ...
  approvalBindingById(
    bindingId: string,
  ): FrozenApprovalContractV2<PersonSlackApprovalBindingContractV2> | undefined;
  ...
  }): FrozenApprovalContractV2<PersonSlackApprovalActionCapabilityV2> | undefined;
...
export interface PersonSlackApprovalFinalizationFenceV2 {
  ...
  readonly transaction: PersonSlackApprovalFinalizationTransactionV2;
}

export interface PersonSlackApprovalFinalizationCoordinatorV2 {
  /**
...
export interface PersonSlackApprovalObserverV2 {
  /**
...
export interface PersonSlackApprovalFinalizationCodecV2 {
  sha256(value: unknown): ApprovalContractSha256;
}

export interface PersonSlackApprovalFinalizationIdFactoryV2 {
  next(kind: "audit_event" | "correlation"): string;
}

export class PersonSlackApprovalFinalizationDeniedError extends Error {}
export class PersonSlackApprovalFinalizationConflictError extends Error {}
...
function denied(): never {
  throw new PersonSlackApprovalFinalizationDeniedError();
}
...
function sameCoordinates(
  ...
  expected: ReprovedFrozenPersonSlackApprovalV2,
): boolean {
...
function reprove<T>(
  ...
  try {
    ...
    if (error instanceof PersonSlackApprovalFinalizationDeniedError) throw error;
    return denied();
  }
}

function frozenApproval(value: unknown): ReprovedFrozenPersonSlackApprovalV2 {
  ...
  return Object.freeze(row) as unknown as ReprovedFrozenPersonSlackApprovalV2;
}

interface PreparedAction {
  readonly approval: ReprovedFrozenPersonSlackApprovalV2;
  ...
  readonly binding: FrozenApprovalContractV2<PersonSlackApprovalBindingContractV2>;
  readonly expectation: PersonSlackApprovalProviderExpectationV2;
  readonly expectation_sha256: ApprovalContractSha256;
}

function prepare(
  fence: PersonSlackApprovalFinalizationFenceV2,
  approvalId: string,
  codec: PersonSlackApprovalFinalizationCodecV2,
): PreparedAction {
...
function reproveStoredUnchecked(
  ...
  const validators: readonly [unknown, ApprovalContractSha256, (value: unknown) => unknown][] = [
    ...
    [set.approval_binding, set.approval_binding_contract_sha256, validatePersonSlackApprovalBindingContractV2],
    [set.action_capability, set.action_capability_contract_sha256, validatePersonSlackApprovalActionCapabilityV2],
...
function recoverStoredForApproval(
  stored: StoredProviderHumanActionV2,
  approvalId: string,
  transaction: PersonSlackApprovalFinalizationTransactionV2,
  codec: PersonSlackApprovalFinalizationCodecV2,
): { readonly result: ProviderHumanActionDurableResult; readonly set: ProviderHumanActionContractSetV2 } {
...
function validateObservation(
  value: PersonSlackApprovalProviderResultV2,
  prepared: PreparedAction,
): Exclude<PersonSlackApprovalProviderResultV2, { kind: "not_resolved" }> {
...
function buildStoredAction(input: {
  ...
  readonly observed: Exclude<PersonSlackApprovalProviderResultV2, { kind: "not_resolved" }>;
  readonly link: FrozenApprovalContractV2<ExternalHumanIdentityLinkContractV2>;
  readonly capability: FrozenApprovalContractV2<PersonSlackApprovalActionCapabilityV2>;
  readonly audit_event_id: string;
...
export async function finalizePersonSlackApprovalV2(input: {
  readonly command: unknown;
  readonly coordinator: PersonSlackApprovalFinalizationCoordinatorV2;
  readonly provider: PersonSlackApprovalObserverV2;
  readonly codec: PersonSlackApprovalFinalizationCodecV2;
  readonly ids: PersonSlackApprovalFinalizationIdFactoryV2;
  readonly now: () => string;
  readonly signal?: AbortSignal;
}): Promise<PersonSlackApprovalFinalizationResultV2> {
