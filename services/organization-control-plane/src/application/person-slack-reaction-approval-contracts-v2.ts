...
export function validateOrganizationToolConnectionContractV2(
  ...
  if (
    scopes.length !== SLACK_REACTION_APPROVAL_REQUIRED_PROVIDER_SCOPES.length ||
    scopes.some(
      (scope, index) =>
        scope !== SLACK_REACTION_APPROVAL_REQUIRED_PROVIDER_SCOPES[index],
    )
  ) {
    invalid(
      `${label} required_provider_scopes`,
...
export interface PersonSlackReactionApprovalBindingContractV2
  extends
...
export type PersonSlackReactionApprovalBindingContractInputV2 = Omit<
  PersonSlackReactionApprovalBindingContractV2,
  "kind" | "schema_version"
>;
...
export function validatePersonSlackReactionApprovalBindingContractV2(
  value: unknown,
): PersonSlackReactionApprovalBindingContractV2 {
  const label = "Person Slack reaction approval binding contract v2";
...
export function buildPersonSlackReactionApprovalBindingContractV2(
  input: PersonSlackReactionApprovalBindingContractInputV2,
): PersonSlackReactionApprovalBindingContractV2 {
  return validatePersonSlackReactionApprovalBindingContractV2({
    ...input,
    schema_version: 2,
...
export interface PersonSlackReactionApprovalActionCapabilityV2
  extends
...
export type PersonSlackReactionApprovalActionCapabilityInputV2 = Omit<
  PersonSlackReactionApprovalActionCapabilityV2,
  "kind" | "schema_version"
>;
...
export function validatePersonSlackReactionApprovalActionCapabilityV2(
  value: unknown,
): PersonSlackReactionApprovalActionCapabilityV2 {
  const label = "Person Slack reaction approval action capability v2";
...
export function buildPersonSlackReactionApprovalActionCapabilityV2(
  input: PersonSlackReactionApprovalActionCapabilityInputV2,
): PersonSlackReactionApprovalActionCapabilityV2 {
  return validatePersonSlackReactionApprovalActionCapabilityV2({
    ...input,
    schema_version: 2,
...
export interface ProviderHumanActionContractSetV2 {
  ...
  readonly external_identity_link_contract_sha256: ApprovalContractSha256;
  readonly approval_binding: PersonSlackReactionApprovalBindingContractV2;
  readonly approval_binding_contract_sha256: ApprovalContractSha256;
  readonly action_capability: PersonSlackReactionApprovalActionCapabilityV2;
  readonly action_capability_contract_sha256: ApprovalContractSha256;
...
interface ValidatedContractSet {
  ...
  readonly binding: PersonSlackReactionApprovalBindingContractV2;
  readonly capability: PersonSlackReactionApprovalActionCapabilityV2;
...
function validateContractSet(
  ...
  const binding = validatePersonSlackReactionApprovalBindingContractV2(
    input.approval_binding,
  );
  const capability = validatePersonSlackReactionApprovalActionCapabilityV2(
