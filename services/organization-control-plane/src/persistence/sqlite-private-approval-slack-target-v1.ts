...
export const PRIVATE_APPROVAL_SLACK_DM_REQUIRED_SCOPES = Object.freeze([
  "im:history",
  "im:write",
] as const);
...
export interface CurrentPrivateApprovalAssigneeV1 {
...
export interface PrivateApprovalSlackTargetCoordinatesV1 {
 ...
 */
export interface CurrentPrivateApprovalSlackTargetV1 {
...
function sameCoordinates(
  ...
  state: PrivateApprovalSlackTargetCoordinatesV1,
): boolean {
  return (
...
/**
 * Resolves one exact, active Slack identity for a current Person assignee.
 *
 ...
 */
export function resolveCurrentPrivateApprovalSlackTargetV1(
  database: Database.Database,
  state: PrivateApprovalSlackTargetCoordinatesV1,
  connectionId: string,
  assignee: CurrentPrivateApprovalAssigneeV1,
): CurrentPrivateApprovalSlackTargetV1 | undefined {
  ...
  if (
    ...
    link.principal_id !== assignee.principal_id ||
    link.membership_id !== assignee.membership_id ||
    link.membership_type !== assignee.membership_type ||
