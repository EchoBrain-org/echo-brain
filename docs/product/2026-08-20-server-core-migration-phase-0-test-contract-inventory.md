...
`response_sha256` with no release binding and no item metadata. It covers the
three context stages and their permitted reasons, the exact per-outcome variant
