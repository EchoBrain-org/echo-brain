...
| D6   | Accepted shared Person-read audit shape, operation-specific scope commitments, retention, export position, and audit-before-byte protocol                                                                                                                                               | Route-specific audit tables, repositories, exporters, expiry code, and CLIs                               | Open; D6-1 through D6-2B private structural bodies green; final fence, audit, retention, export, opaque-preimage persistence/reproof, and live removal pending |
