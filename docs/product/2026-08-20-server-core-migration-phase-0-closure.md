...
| D6   | Accepted shared Person-read audit shape, operation-specific scope commitments, retention, export position, and audit-before-byte protocol                                                                                                                                               | Route-specific audit tables, repositories, exporters, expiry code, and CLIs                               | Open; D6-1 request/caller and D6-2A structural scope bodies green; release, audit, retention, export, opaque-preimage persistence/reproof, and live removal pending |
