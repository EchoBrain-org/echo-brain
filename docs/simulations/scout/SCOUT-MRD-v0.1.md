...
The companion `SCOUT-PRD-v0.1.md` translates these needs into proposed product behavior. If the two documents disagree, raise the conflict for PM resolution rather than silently choosing one.
