...
export interface OrganizationEnrollmentChallengeV1 extends SignedDocument {
  schema_version: 1;
  kind: 'echo-organization-enrollment-challenge';
  challenge_id: FederationId;
  authority_id: FederationId;
  organization_id: FederationId;
  principal_id: FederationId;
  membership_id: FederationId;
...
export interface OrganizationEnrollmentProofV1 extends SignedDocument {
  schema_version: 1;
...
export type OrgIngestReceiptStatus =
  'accepted' | 'duplicate' | 'rejected' | 'quarantined';

export type OrgIngestReason =
  | 'membership_revoked'
...
export interface OrgIngestReceiptV1 extends SignedDocument {
  schema_version: 1;
  ...
  canonical_record_id: FederationId | null;
