...
organization trust, enrollment, and access high-watermark tables, bringing the
installation schema to thirteen tables. Existing numbered migrations must not
be rewritten; schema changes are appended as the next contiguous migration.
