...
const log = createLogger("adapters.meeting-sources.granola.compatibility");
...
export function granolaCheckpointPath(checkpointDirectory: string): string {
  return join(checkpointDirectory, "granola-raw-events.json");
}
