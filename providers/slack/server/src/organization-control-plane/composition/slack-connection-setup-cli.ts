...
import { canonicalJson } from "@echo-brain/organization-control-plane/canonical/canonical-json";
...
import { connectSlackConnectionV1, type ConnectedSlackConnectionV1, type SlackConnectionVerifierV1 } from "../persistence/sqlite-slack-connection-coordinator-v1.js";
import {
  verifyOrganizationControlStateV1,
  type VerifiedOrganizationControlStateV1,
} from "@echo-brain/organization-control-plane/persistence/verified-organization-control-state-v1";
