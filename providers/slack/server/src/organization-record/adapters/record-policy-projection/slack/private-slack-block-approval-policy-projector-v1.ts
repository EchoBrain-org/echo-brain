...
} from "@echo-brain/organization-record/application/record-policy-fact-projection-v1";
import {
...
} from "@echo-brain/organization-record/application/person-policy-fact-contracts-v2";
