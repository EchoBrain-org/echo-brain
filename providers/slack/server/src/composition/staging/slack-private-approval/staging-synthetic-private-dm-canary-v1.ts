import { assertCanonicalDecisionSet } from "@echo-brain/organization-processing/core/contracts/validation";
...
import type {
  ...
  DecisionSet,
} from "@echo-brain/organization-processing/core/contracts/decision";
