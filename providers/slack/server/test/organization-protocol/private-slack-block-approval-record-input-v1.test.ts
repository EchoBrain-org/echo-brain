import { createRecordInputCodecRegistryV4 } from "../../../../../packages/organization-protocol/src/index.js";
import { PRIVATE_SLACK_BLOCK_APPROVAL_RECORD_INPUT_CODEC_V1 } from "../../src/organization-protocol/private-slack-block-approval-record-input-v1.js";
import { describe, expect, it } from "vitest";
import { organizationMemberReadablePersonConsequenceSha256, organizationMemberReadablePersonPolicyContractSha256, ORGANIZATION_MEMBER_READABLE_PERSON_CONSEQUENCE_TEXT, RESTRICTED_REVIEWER_PERSON_CONSEQUENCE_TEXT, RESTRICTED_REVIEWER_PERSON_POLICY_ID, restrictedReviewerPersonConsequenceSha256, restrictedReviewerPersonPolicyContractSha256 } from "../../../../../packages/organization-protocol/src/index.js";
import { PRIVATE_SLACK_BLOCK_APPROVAL_RESOLUTION_REF_V1_KIND, SIGNED_SLACK_BLOCK_ACTION_V1_KIND, buildPrivateSlackBlockApprovalRecordInputV1, privateSlackBlockApprovalResolutionRefV1Sha256, validatePrivateSlackBlockApprovalRecordInputV1, validatePrivateSlackBlockApprovalResolutionRefV1 } from "../../src/organization-protocol/private-slack-block-approval-record-input-v1.js";
import {
