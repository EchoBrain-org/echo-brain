...
const EXPECTED_RELEASE_OWNERSHIP = [
  ...
  ["/services/organization-control-plane/package.json", "@EchoBrain-org"],
  ["/services/organization-control-plane/tsconfig.json", "@EchoBrain-org"],
  ["/services/organization-record/package.json", "@EchoBrain-org"],
  ["/services/organization-record/tsconfig.json", "@EchoBrain-org"],
  ["/services/organization-retrieval/package.json", "@EchoBrain-org"],
  ["/services/organization-retrieval/tsconfig.json", "@EchoBrain-org"],
