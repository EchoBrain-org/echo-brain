...
describe('ordinary npm package', () => {
  it('contains the CLI, public schema, SQLite migrations, adapters, license, and metadata', () => {
    ...
    for (const required of [
      ...
      'package/dist/product/federation/authority.js',
      'package/dist/product/federation/authority.d.ts',
      'package/dist/product/federation/organization-sync.js',
      'package/dist/product/federation/organization-sync.d.ts',
      ...
      'package/dist/storage/migrations/0004_organization_sync.sql',
      'package/dist/product/federation/authority/migrations/0001_organization_authority.sql',
      ...
      'package/schemas/product/organization-enrollment-challenge.v1.schema.json',
      'package/schemas/product/organization-enrollment-proof.v1.schema.json',
      'package/schemas/product/organization-enrollment-receipt.v1.schema.json',
      'package/schemas/product/org-ingest-receipt.v1.schema.json',
