  ...
  it('contains only the fenced product closure and no repository path', () => {
    ...
    expect(paths).toEqual(
      expect.arrayContaining([
        ...
        'schemas/product/organization-enrollment-challenge.v1.schema.json',
        'schemas/product/organization-enrollment-proof.v1.schema.json',
        'schemas/product/organization-enrollment-receipt.v1.schema.json',
        'schemas/product/org-ingest-receipt.v1.schema.json',
        ...
        'dist/product/federation/authority.js',
        'dist/product/federation/authority.d.ts',
        'dist/product/federation/organization-sync.js',
        'dist/product/federation/organization-sync.d.ts',
