...
### Planned staging journey overview - separate stack
...
database, log subscription, browser AWS credential, production resource,
production deployment, or production observability claim. Its definitions,
dashboard layout, quick-detection thresholds, and deferred Explorer/live
rehearsal are in
